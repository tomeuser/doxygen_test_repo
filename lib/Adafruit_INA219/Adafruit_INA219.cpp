 ...
 *          of current.  Each unit of current corresponds to 100uA, and each
 *          unit of power corresponds to 2uW. Counter overflow occurs at
 *          3.2A.
 *  @note   These calculations assume a 0.150 ohm resistor is present
 */
void Adafruit_INA219::setCalibration_150mohm() {
    ...
    // RSHUNT = 0.150			(Resistor value in ohms)

    // 1. Determine max possible current
    // MaxPossible_I = VSHUNT_MAX / RSHUNT
    // MaxPossible_I = 2.1333A
    ...
    // End If
    //
    // Results in Max_Current_Before_Overflow = 2.1333A
    //
    ...
    // End If
    //
    // Results in Max_ShuntVoltage_Before_Overflow = 0.32
    ...
    ina219_currentDivider_mA = 10; // CurrentLSB = 100uA per bit (1000/100 = 10)
    ina219_powerMultiplier_mW = 2; // PowerLSB = 2mW per bit
