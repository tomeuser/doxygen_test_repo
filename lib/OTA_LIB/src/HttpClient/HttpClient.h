...
public:
    ...
    */
    ...
    void sendHeader(const String &aHeaderName, const String &aHeaderValue) { sendHeader(aHeaderName.c_str(), aHeaderValue.c_str()); }
    ...
    */
    ...
    void sendHeader(const String &aHeaderName, const int aHeaderValue) { sendHeader(aHeaderName.c_str(), aHeaderValue); }
    ...
    */
    ...
    void sendBasicAuth(const String &aUser, const String &aPassword) { sendBasicAuth(aUser.c_str(), aPassword.c_str()); }
...
protected:
    ...
    */
    ...
    // processing)
    static const int kHttpResponseTimeout = 100 * 1000;
